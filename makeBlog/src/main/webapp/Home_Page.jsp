						...
						<ul class="navbar-nav ms-auto">
							...
							<li class="nav-item dropdown"><a
								...
								<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
									<li><a class="dropdown-item" href="see_post.jsp">Java Language</a></li>
									<li><hr class="dropdown-divider"></li>
									<li><a class="dropdown-item" href="see_post.jsp">Python Language</a></li>
									<li><hr class="dropdown-divider"></li>
									<li><a class="dropdown-item" href="see_post.jsp">Web Development</a></li>
									<li><hr class="dropdown-divider"></li>
									<li><a class="dropdown-item" href="see_post.jsp">Misc</a></li>
								</ul></li>
