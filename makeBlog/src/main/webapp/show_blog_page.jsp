    			...
    			<div class="card mt-5 border border-white">
					...
					<div class="card-body ">
							...
							<ul style="display: flex; align-items: center; list-style: none;">
								<li style="display: flex; align-items: center; margin-right: 20px;">
				    				...
				    				<p style="font-size: 22px;">
				    					<i class="fa-regular fa-user" style="color: #008374; font-size: 16px; margin-right: 6px;"></i>
				    					<a href= "Post_user_profile.jsp?user_id=<%=p.getUserId()%>" style="text-decoration: none; text-transform: uppercase; font-weight: 600; color: #6c757d;"> <%= ud.getUserByUserId(p.getUserId()).getName() %></a>
				    				</p>
								</li>
								<li style="display: flex; align-items: center; margin-right: 20px;">
									<p style="font-style: italic; font-family: 600; font-size: 18px;">
								...
								<li style="display: flex; align-items: center;">
									<p style="font-size: 18px;">
										<a href="#!"><i class="far fa-comment-dots"
												style="color: #008374; font-size: 18px; margin-right: 6px;"></i></a>
										 comments
									</p>
								</li>
						...
						<li style="font-size: 15px;">
			  			...
			  			<div class="clearfix">
			    			<span class="float-start text-white " style="padding: 3px 25px; background: rgb(0, 128, 128); border-radius: 20px; font-size: 20px;"><%=ct.getName()%></span>
							...
							<div class="clearfix">
			    				<span class="float-end" >
									...
									<a href="#!" class="btn btn"><i class="far fa-comment-dots"
											style="color: #10927c;"></i> <span> </span> </a>
			    			</span>
			  			</div>
						</div>
					</div>
