			...
			<div class="bg-white col-auto col-xl-2 p-0 min-vh-100 d-flex flex-column justify-content-between ">
				<div class="bg-white p-4 py-sm-4">
					...
					<ul class="nav nav-pills flex-column mt-3 sfsf">
						...
						<li class="nav-item py-2 py-sm-1 border"><a href="LogoutServlet"
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					<li class="nav-item  fs-5 ms-4"><a class="nav-link active"
						aria-current="page" href="Home_Page.jsp">Home</a></li>
					<li class="nav-item fs-5 ms-4"><a class="nav-link active"
						href="create_post.jsp">Create Post</a>
					</li>
					<li class="nav-item fs-5 ms-4"><a class="nav-link active"
						href="#">Contact</a>
					</li>
					<li class="nav-item fs-5 ms-4">
						<a class="nav-link active" href="profile.jsp" data-bs-toggle="modal" data-bs-target="#profile-modal"> <span class="fa fa-user-circle"></span> 
							<%= user.getName() %>
						</a>
					</li>
