...
<body>
	...
	<div class="row offset-md-2">
		...
		%>
				...
				<h1 class="text-primary" style="font-size:100px; display: inline-block;">You have not posted anything </h1>
		...
		%>
			...
			<div class="col-md-6 mt-2 mb-1">
				<div class="card border border-1 shadow-sm p-3 mb-4 "
					...
					<div class="clearfix">
		 				<span class="float-start mt-2 " style="font-size: 16px; color: #6c757d; margin-left: 3px;"><i class="fa-regular fa-user" style="color: #008374; font-size: 15px; margin-right: 6px;"></i><%= ud1.getUserByUserId(p.getUserId()).getName() %></span>
